...
class Tooltip {
    ...
    constructor(element : HTMLElement, container : HTMLElement, tooltip : HTMLElement|string){
        ...
        console.log("tooltip", this.tooltip, tooltip)
        /**
    ...
    autoPlace (left_cushion : number = 0, top_cushion : number = 0){
        ...
        console.log("coordinate", coordinate, this.tooltip, auto_offsets, left_coordinate, top_coordinate, this.centered_coordinate)
